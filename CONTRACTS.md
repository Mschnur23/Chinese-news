...
- Link extraction requests main, clean content and then deterministically isolates the continuous editorial body. Navigation, share controls, comment prompts, editor lines, and recommendation feeds are not article paragraphs.
- The original article text renders before the optional language guide, publication context, brief, and related-reading material; those supporting sections remain visually distinct.
